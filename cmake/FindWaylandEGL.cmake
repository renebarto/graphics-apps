...
# find include paths
find_path(WAYLAND_EGL_INCLUDE_DIR wayland-egl.h ${CMAKE_FRAMEWORK_PATH}/include ${PC_WAYLAND_SERVER_INCLUDE_DIRS})

# find libs
find_library(WAYLAND_EGL_LIBRARIES NAMES ${PC_WAYLAND_EGL_LIBRARIES} PATHS ${CMAKE_FRAMEWORK_PATH}/lib ${PC_WAYLAND_EGL_LIBRARY_DIRS})
